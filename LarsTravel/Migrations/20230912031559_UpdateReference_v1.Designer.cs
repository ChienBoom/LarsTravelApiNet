...
namespace LarsTravel.Migrations
{
    ...
    [Migration("20230912031559_UpdateReference_v1")]
    partial class UpdateReference_v1
    {
            ...
            modelBuilder.Entity("LarsTravel.Models.Comment", b =>
                {
                    b.HasOne("LarsTravel.Models.Evaluate", "Evaluate")
                        .WithOne("Comment")
                        .HasForeignKey("LarsTravel.Models.Comment", "EvaluateId")
            ...
            modelBuilder.Entity("LarsTravel.Models.Tour", b =>
                {
                    ...
                    b.HasOne("LarsTravel.Models.Evaluate", "Evaluate")
                        .WithOne("Tour")
                        .HasForeignKey("LarsTravel.Models.Tour", "EvaluateId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
